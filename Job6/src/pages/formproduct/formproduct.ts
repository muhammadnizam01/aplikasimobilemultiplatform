...
export class FormproductPage {
  ...
  //deklarasi variabel untuk gambar yang dihasilkan dari camera
  imageUri:any;
  imageFileName:any;
  ...
  //fungsi untuk membuka camera atau galery
  getImage(sourceType) {
  ...
  //fungsi untuk ActionSheet camera
  //mengambil gambar dari camera atau galery
  presentActionSheet(){
